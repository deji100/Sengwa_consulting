        ...
        <div className="about-us">
            <div className="inner">
                ...
                <div className="content">
                    ...
                    <p>{"At Sengwa Consulting, your success is our priority. Let us take the weight off your shoulders and guide you towards a brighter career future. Together, we'll turn your job search into a journey of growth and achievement."}</p>
                </div>
            </div>
        </div>
    );
